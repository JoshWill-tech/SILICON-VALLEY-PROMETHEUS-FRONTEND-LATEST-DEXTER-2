...
import { EditorSidebarMotionDrawerV2 } from '@/components/editor/sidebar/editor-sidebar-motion-drawer-v2'

export function EditorRouteShellMotionV2({ children }: { children: ReactNode }) {
