  ...
  return (
    <motion.article
      ...
      className={cn(
        ...
        tone.border,
        isPreviewing && (hasAudioError ? "border-rose-500/40" : tone.previewBorder),
              ...
              >
                <span className="inline-flex items-center gap-2">
                  {hasAudioError ? (
                    ...
                    <>
                      <Pause className="size-4 text-[#7ff2d4] opacity-40" />
                      <span className="animate-pulse">Buffering AI Stream...</span>
                    </>
                  ) : (
                    <>
